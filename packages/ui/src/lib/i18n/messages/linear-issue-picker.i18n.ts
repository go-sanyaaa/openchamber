...
export const linearIssuePickerI18n = {
  ...
  ru: {
    'chat.chatInput.actions.linkLinearIssue': 'Привязать задачу Linear',
    'chat.chatInput.linked.linearIssue.openInBrowserAria': 'Открыть задачу в Linear',
    'chat.chatInput.linked.linearIssue.removeAria': 'Удалить привязанную задачу Linear',
    'session.linearIssuePicker.title': 'Привязать задачу Linear',
    'session.linearIssuePicker.description': 'Выберите задачу из подключенного рабочего пространства Linear.',
    'session.linearIssuePicker.searchPlaceholder': 'Поиск по названию, идентификатору или URL Linear',
    'session.linearIssuePicker.empty.notConnected': 'Linear не подключен. Подключите его в разделе «Настройки» → «Интеграции».',
    ...
    'session.linearIssuePicker.actions.loadMore': 'Загрузить еще',
    'session.linearIssuePicker.actions.openInLinearAria': 'Открыть в Linear',
    'session.linearIssuePicker.toast.loadMoreFailed': 'Не удалось загрузить другие задачи',
    'session.linearIssuePicker.toast.loadIssueDetailsFailed': 'Не удалось загрузить сведения о задаче',
    'session.linearIssuePicker.error.notConnected': 'Linear не подключен',
    ...
    'session.linearIssuePicker.description.createSession': 'Создает сессию в проекте, связанном с этой командой Linear, и использует задачу как первый запрос.',
    'session.linearIssuePicker.error.noMappedProject': 'Свяжите эту команду Linear с проектом в разделе «Настройки» → «Интеграции»',
