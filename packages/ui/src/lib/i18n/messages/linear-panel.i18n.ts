...
export const linearPanelI18n = {
  ...
  ru: {
    'contextPanel.mode.linear': 'Linear',
    'contextRail.surface.linear.description': 'Просматривайте задачи Linear, меняйте их статус и начинайте сессию',
    'contextPanel.linear.actions.backToList': 'Назад к задачам',
    'contextPanel.linear.actions.startSession': 'Начать сессию',
    ...
    'contextPanel.linear.filter.searchAria': 'Искать задачи',
    'contextPanel.linear.filter.clear': 'Сбросить',
    'contextPanel.linear.filter.clearAria': 'Сбросить фильтры задач',
    ...
    'contextPanel.linear.empty.noMatchingIssues': 'Нет задач, соответствующих этим фильтрам',
    ...
    'contextPanel.linear.toast.workspaceSwitched': 'Рабочее пространство Linear переключено',
    'contextPanel.linear.toast.workspaceSwitchFailed': 'Не удалось переключить рабочее пространство Linear',
