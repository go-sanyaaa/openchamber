...
export const linearIntegrationI18n = {
  ...
  ru: {
    'settings.integrations.github.title': 'GitHub',
    'settings.integrations.github.description': 'Подключите аккаунт GitHub для работы с пул-реквестами и задачами.',
    ...
    'settings.integrations.firstParty.info': 'Аккаунты сервисов и встроенных расширений OpenChamber. Учётные данные хранятся на выбранном экземпляре.',
    'settings.integrations.linear.title': 'Linear',
    'settings.integrations.linear.description': 'Подключите рабочие пространства Linear к этому серверу OpenChamber.',
    'settings.integrations.linear.info': 'Подключите одно или несколько рабочих пространств Linear. OpenChamber хранит данные входа на этом компьютере, чтобы ими могли пользоваться веб-версия, приложение для компьютера и подключённый телефон.',
    ...
    'settings.integrations.linear.flow.description': 'Завершите вход в только что открывшейся вкладке браузера.',
    ...
    'settings.integrations.linear.toast.workspaceSwitched': 'Рабочее пространство Linear переключено',
    'settings.integrations.linear.toast.workspaceSwitchFailed': 'Не удалось переключить рабочее пространство Linear',
    ...
    'settings.integrations.linear.toast.authorizationFailed': 'Время ожидания авторизации Linear истекло. Нажмите «Подключить», чтобы повторить попытку.',
    'settings.integrations.linear.avatarAlt.withName': 'Аватар {name} в Linear',
    'settings.integrations.linear.avatarAlt.fallback': 'Аватар Linear',
    ...
    'settings.integrations.linear.mapping.defaultProject.info': 'Новые сессии из задач Linear используют этот проект, если для команды задачи не настроено отдельное сопоставление.',
    ...
    'settings.integrations.linear.mapping.teams.info': 'Необязательно. Задача сопоставленной команды откроется в указанном проекте, а не в проекте по умолчанию.',
    'settings.integrations.linear.mapping.teams.useDefault': 'Использовать проект по умолчанию',
    ...
    'settings.integrations.linear.sessionComments.label': 'Комментарии о сессии',
    'settings.integrations.linear.sessionComments.info': 'Добавляет комментарий к задаче при запуске, завершении или сбое сессии. Комментарии публикуются, только если у этого сервера есть общедоступный адрес, чтобы все участники задачи могли открыть сессию по ссылке.',
    'settings.integrations.linear.sessionComments.aria': 'Публиковать комментарии о состоянии сессии в Linear',
    'settings.integrations.linear.sessionComments.loadFailed': 'Не удалось загрузить настройки комментариев Linear.',
    'settings.magicPrompts.sidebar.group.linear': 'Linear',
    'settings.magicPrompts.sidebar.item.linearIssueReview': 'Проверка задачи',
    'settings.magicPrompts.page.group.linearIssueReview.title': 'Проверка задачи',
    'settings.magicPrompts.page.group.linearIssueReview.description': 'Промпты для запуска сессии из задачи Linear: видимое сообщение пользователя и скрытые инструкции.',
  },
} as const;
